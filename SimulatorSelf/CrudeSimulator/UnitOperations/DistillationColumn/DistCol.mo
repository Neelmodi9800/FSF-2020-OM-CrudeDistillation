within CrudeSimulator.UnitOperations.DistillationColumn;
  ...
  model DistCol "Model of a distillation column representing fractionating towers where mixture is separated in equilibrium stages"
    ...
    Dialog(tab = "Column Specifications", group = "Component Parameters"));
    import data = CrudeSimulator.Files.ChemsepDatabase;
    parameter Boolean Bin_t[Nt] = CrudeSimulator.Files.OtherFunctions.colBoolCalc(Nt, Ni, InT_s) "Stream stage associations" annotation(
    Dialog(tab = "Column Specifications", group = "Component Parameters"));
    ...
    Real RR(min = 0);
    CrudeSimulator.Files.Interfaces.matConn In_s[Ni](each Nc = Nc) annotation(
    ...
    CrudeSimulator.Files.Interfaces.matConn Dist(Nc = Nc) annotation(
    ...
    CrudeSimulator.Files.Interfaces.matConn Bot(Nc = Nc) annotation(
    ...
    CrudeSimulator.Files.Interfaces.enConn Cduty annotation(
    ...
    CrudeSimulator.Files.Interfaces.enConn Rduty annotation(
    ...
    CrudeSimulator.Files.Interfaces.matConn Out_s[Nout](each Nc = Nc) annotation(
    ...
    CrudeSimulator.Files.Interfaces.enConn En[NQ](each Nc = Nc) annotation(
